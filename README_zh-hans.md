...
1. **[ConvNeXt MaskRCNN](https://huggingface.co/docs/transformers/main/model_doc/convnext_maskrcnn)** (来自 Facebook AI) 伴随论文 [A ConvNet for the 2020s](https://arxiv.org/abs/2201.03545) 由 Zhuang Liu, Hanzi Mao, Chao-Yuan Wu, Christoph Feichtenhofer, Trevor Darrell, Saining Xie 发布。
