...
1. **[ConvNextMaskRCNNMaskRCNN](https://huggingface.co/docs/transformers/model_doc/convnext_maskrcnn)** (from <FILL INSTITUTION>) released with the paper [<FILL PAPER TITLE>](<FILL ARKIV LINK>) by <FILL AUTHORS>.
