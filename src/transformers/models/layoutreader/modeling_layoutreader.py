...
# Copied from transformers.models.bert.modeling_bert.BertLMPredictionHead with Bert->LayoutReader
...
# Copied from transformers.models.bert.modeling_bert.BertOnlyMLMHead with Bert->LayoutReader
class LayoutReaderOnlyMLMHead(nn.Module):
    def __init__(self, config):
        super().__init__()
        self.predictions = LayoutReaderLMPredictionHead(config)
...
class LayoutReaderModel(LayoutReaderPreTrainedModel):
    def __init__(self, config):
        ...
        self.pooler = LayoutReaderPooler(config)
...
class LayoutReaderForPreTraining(LayoutReaderPreTrainedModel):
    def __init__(self, config):
        ...
        self.cls = LayoutReaderOnlyMLMHead(config)
