...
try:
    ...
    _import_structure["modeling_beitv2"] = [
...
if TYPE_CHECKING:
    from .configuration_beitv2 import BEITV2_PRETRAINED_CONFIG_ARCHIVE_MAP, Beitv2Config, Beitv2OnnxConfig
