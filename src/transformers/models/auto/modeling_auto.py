...
MODEL_FOR_SEQUENCE_CLASSIFICATION_MAPPING = OrderedDict(
    [
        ...
        (ViTConfig, ViTForSequenceClassification),
...
MODEL_FOR_QUESTION_ANSWERING_MAPPING = OrderedDict(
    [
        ...
        (ViTConfig, ViTForQuestionAnswering),
...
(ViTConfig, ViTForTokenClassification),
...
(ViTConfig, ViTForMultipleChoice),
