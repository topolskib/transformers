...
MODEL_FOR_SEQUENCE_CLASSIFICATION_MAPPING_NAMES = OrderedDict(
    [
        ...
        ("git", "GITForSequenceClassification"),
...
MODEL_FOR_NEXT_SENTENCE_PREDICTION_MAPPING_NAMES = OrderedDict(
    [
        ...
        ("git", "GITForNextSentencePrediction"),
