...
class OwlViTConfig(PretrainedConfig):
    r"""
    [`OwlViTConfig`] is the configuration class to store the configuration of a [`OwlViTModel`]. It is used to
    instantiate OwlViT model according to the specified arguments, defining the text model and vision model configs.
