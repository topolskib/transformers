...
# Copied from transformers.models.bert.modeling_bert.BertForMaskedLM with Bert -> Tapas
    ...
    def forward(
        ...
        **kwargs
        ...
        Examples::
            ...
            >>> tokenizer = TapasTokenizer.from_pretrained('google/tapas-base-mlm')
            >>> model = TapasForMaskedLM.from_pretrained('google/tapas-base-mlm')
