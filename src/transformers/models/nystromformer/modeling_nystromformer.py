# coding=utf-8
# Copyright 2021 Microsoft The HuggingFace Inc. team. All rights reserved.
#
...
NYSTROMFORMER_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~transformers.NystromformerConfig`): Model configuration class with all the parameters of the model.
...
NYSTROMFORMER_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`torch.LongTensor` of shape :obj:`({0})`):
            ...
            Indices can be obtained using :class:`transformers.NystromformerTokenizer`. See
