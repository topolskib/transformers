...
_CHECKPOINT_FOR_DOC = "idea-research/grounding-dino-swin-tiny"

GROUNDING_DINO_PRETRAINED_MODEL_ARCHIVE_LIST = [
    "idea-research/grounding-dino-swin-tiny",
    # See all Grounding DINO models at https://huggingface.co/models?filter=grounding_dino
]
...
def replace_batch_norm(m, name=""):
    for attr_str in dir(m):
        ...
        if isinstance(target_attr, nn.BatchNorm2d):
            frozen = GroundingDINOFrozenBatchNorm2d(target_attr.num_features)
