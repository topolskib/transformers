...
class BatchImages(UserDict):
    r"""
    Holds the output of the :meth:`~transformers.ImageProcessor.pad` and image processor specific
    ``__call__`` methods.
...
class PreTrainedImageProcessor:
    ...
    def from_pretrained(
        ...
        r"""
        Instantiate a :class:`~transformers.PreTrainedImageProcessor` (or a derived class) from a pretrained image processor.
    ...
    def get_image_processor_dict(
        ...
        Returns:
            :obj:`Tuple[Dict, Dict]`: The dictionary(ies) that will be used to instantiate the image processor
            object.
        """
    ...
    def to_json_string(self) -> str:
        ...
        Returns:
            :obj:`str`: String containing all the attributes that make up this image_processor instance in JSON
            format.
        """
    ...
    def pad(
        ...
        """
        Pad input values or a batch of input values up to predefined resolution or to the
