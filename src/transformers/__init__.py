...
_import_structure = {
    ...
    "models.detr": ["DETR_PRETRAINED_CONFIG_ARCHIVE_MAP", "DetrConfig", "DetrTokenizer", "DetrImageProcessor"],
...
if TYPE_CHECKING:
    ...
    from .models.detr import DETR_PRETRAINED_CONFIG_ARCHIVE_MAP, DetrConfig, DetrImageProcessor, DetrTokenizer
