...
class TFDinov2ForImageClassification(metaclass=DummyObject):
    _backends = ["tf"]
...
class TFDinov2Model(metaclass=DummyObject):
    _backends = ["tf"]
...
class TFDinov2PreTrainedModel(metaclass=DummyObject):
    _backends = ["tf"]
