...
TAPEX_PRETRAINED_MODEL_ARCHIVE_LIST = None


class TapexForCausalLM:
    def __init__(self, *args, **kwargs):
        requires_backends(self, ["torch"])
...
class TapexForQuestionAnswering:
    def __init__(self, *args, **kwargs):
        requires_backends(self, ["torch"])
...
class TapexForSequenceClassification:
    def __init__(self, *args, **kwargs):
        requires_backends(self, ["torch"])
...
class TapexForTokenClassification:
    def __init__(self, *args, **kwargs):
        requires_backends(self, ["torch"])
...
def load_tf_weights_in_tapex(*args, **kwargs):
    requires_backends(load_tf_weights_in_tapex, ["torch"])
