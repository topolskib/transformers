...
H3_PRETRAINED_MODEL_ARCHIVE_LIST = None


class H3ForCausalLM(metaclass=DummyObject):
    _backends = ["torch"]
...
class H3Model(metaclass=DummyObject):
    _backends = ["torch"]
...
class H3PreTrainedModel(metaclass=DummyObject):
    _backends = ["torch"]
