...
1. **[ConvNeXt MaskRCNN](https://huggingface.co/docs/transformers/main/model_doc/convnext_maskrcnn)** (from Facebook AI) released with the paper [A ConvNet for the 2020s](https://arxiv.org/abs/2201.03545) by Zhuang Liu, Hanzi Mao, Chao-Yuan Wu, Christoph Feichtenhofer, Trevor Darrell, Saining Xie.
