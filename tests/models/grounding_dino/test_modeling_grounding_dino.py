...
from transformers import GroundingDINOConfig, is_timm_available, is_vision_available
...
if is_timm_available():
    ...
    from transformers import GroundingDINOForObjectDetection, GroundingDINOModel, ResNetConfig
...
class GroundingDINOModelTest(ModelTesterMixin, GenerationTesterMixin, PipelineTesterMixin, unittest.TestCase):
    all_model_classes = (GroundingDINOModel, GroundingDINOForObjectDetection) if is_timm_available() else ()
    ...
    def test_grounding_dino_no_timm_backbone(self):
        config_and_inputs = self.model_tester.prepare_config_and_inputs()
