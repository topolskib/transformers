...
class InstructBlipModelIntegrationTest(unittest.TestCase):
    def test_inference_vicuna_7b(self):
        ...
        # fmt: off
        expected_outputs = [0, 450, 22910, 9565, 310, 445, 1967, 338, 393, 263, 767, 297, 13328, 528, 2728, 322, 3273, 29879, 29892, 1058, 5692, 304, 367, 13977, 292, 22095, 373, 278, 1250, 12949, 470, 17526, 1153, 384, 4038, 310, 670, 1559, 1550, 19500, 1623, 385, 17164, 11952, 29889, 910, 6434, 1033, 19998, 18593, 15332, 5161, 2039, 363, 1716, 1075, 408, 1532, 408, 916, 6520, 4160, 2861, 304, 1320, 336, 1953, 8581, 491, 11415, 425, 870, 719, 2645, 9850, 931, 2012, 12789, 4746, 14419, 368, 373, 9109, 19716, 5858, 5544, 747, 9770, 763, 12469, 14243, 752, 13036, 2, 1]
        # fmt: on
