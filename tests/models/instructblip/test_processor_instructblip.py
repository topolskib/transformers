...
class InstructBlipProcessorTest(unittest.TestCase):
    def setUp(self):
        ...
        processor = InstructBlipProcessor(image_processor, tokenizer)
    ...
    def test_save_load_pretrained_additional_features(self):
        processor = InstructBlipProcessor(tokenizer=self.get_tokenizer(), image_processor=self.get_image_processor())
        processor.save_pretrained(self.tmpdirname)
    ...
    def test_image_processor(self):
        ...
        processor = InstructBlipProcessor(tokenizer=tokenizer, image_processor=image_processor)
