...
if is_torch_available():
    ...
    from transformers.models.markuplm.modeling_markuplm import MARKUPLM_PRETRAINED_MODEL_ARCHIVE_LIST
...
class MarkupLMModelTester:
    ...
    def create_and_check_for_causal_lm(
        ...
        model = MarkupLMForCausalLM(config=config)
        model.to(torch_device)
        model.eval()
...
class MarkupLMModelTest(ModelTesterMixin, unittest.TestCase):
    ...
    all_generative_model_classes = (MarkupLMForCausalLM,) if is_torch_available() else ()
    ...
    def test_model_from_pretrained(self):
        for model_name in MARKUPLM_PRETRAINED_MODEL_ARCHIVE_LIST[:1]:
...
class MarkupLMModelIntegrationTest(unittest.TestCase):
    ...
    def test_inference_masked_lm(self):
        model = MarkupLMForMaskedLM.from_pretrained("microsoft/markuplm-base")
