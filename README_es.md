...
1. **[UperNet](https://huggingface.co/docs/transformers/main/model_doc/upernet)** (from <FILL INSTITUTION>) released with the paper [<FILL PAPER TITLE>](<FILL ARKIV LINK>) by <FILL AUTHORS>. 
1. **[UPerNet](https://huggingface.co/docs/transformers/main/model_doc/upernet)** (from <FILL INSTITUTION>) released with the paper [<FILL PAPER TITLE>](<FILL ARKIV LINK>) by <FILL AUTHORS>. 
