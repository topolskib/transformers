...
1. **[Hierarchical Attention Transformer](https://huggingface.co/docs/transformers/main/model_doc/hat)** (from <FILL INSTITUTION>) released with the paper [<FILL PAPER TITLE>](<FILL ARKIV LINK>) by <FILL AUTHORS>. 
