...
1. **[UDOP](https://huggingface.co/docs/transformers/main/model_doc/udop)** (from <FILL INSTITUTION>) released with the paper [<FILL PAPER TITLE>](<FILL ARKIV LINK>) by <FILL AUTHORS>. 
