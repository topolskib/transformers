...
1. **[DETA](https://huggingface.co/docs/transformers/main/model_doc/deta)** (from <FILL INSTITUTION>) released with the paper [<FILL PAPER TITLE>](<FILL ARKIV LINK>) by <FILL AUTHORS>. 
