...
1. **[BEiTv2](https://huggingface.co/docs/transformers/main/model_doc/beitv2)** (from <FILL INSTITUTION>) released with the paper [<FILL PAPER TITLE>](<FILL ARKIV LINK>) by <FILL AUTHORS>. 
